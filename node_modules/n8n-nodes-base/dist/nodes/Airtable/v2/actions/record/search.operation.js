    ...
    for (let i = 0; i < itemsLength; i++) {
        try {
            ...
            if (options.downloadFields) {
                const itemWithAttachments = await transport_1.downloadRecordAttachments.call(this, responseData.records, options.downloadFields, nodeVersion >= 2.1 ? [{ item: i }] : undefined);
