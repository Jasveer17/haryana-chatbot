...
class WorkflowExecute {
    ...
    runPartialWorkflow2(workflow, runData, pinData = {}, dirtyNodeNames = [], destinationNodeName) {
        ...
        const { nodeExecutionStack, waitingExecution, waitingExecutionSource } = (0, partial_execution_utils_1.recreateNodeExecutionStack)(graph, new Set(startNodes), runData, pinData ?? {});
        this.status = 'running';
        this.runExecutionData = {
            startData: {
