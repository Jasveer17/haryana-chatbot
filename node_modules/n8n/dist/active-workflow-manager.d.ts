...
import type { ExecutionError, IWorkflowBase, IWorkflowExecuteAdditionalData, WorkflowActivateMode, WorkflowExecuteMode } from 'n8n-workflow';
...
export declare class ActiveWorkflowManager {
    ...
    getExecutePollFunctions(workflowData: IWorkflowBase, additionalData: IWorkflowExecuteAdditionalData, mode: WorkflowExecuteMode, activation: WorkflowActivateMode): IGetExecutePollFunctions;
    getExecuteTriggerFunctions(workflowData: IWorkflowBase, additionalData: IWorkflowExecuteAdditionalData, mode: WorkflowExecuteMode, activation: WorkflowActivateMode): IGetExecuteTriggerFunctions;
    ...
    add(workflowId: string, activationMode: WorkflowActivateMode, existingWorkflow?: IWorkflowBase, { shouldPublish }?: {
    ...
    addTriggersAndPollers(dbWorkflow: IWorkflowBase, workflow: Workflow, { activationMode, executionMode, additionalData, }: {
