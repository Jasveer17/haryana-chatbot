...
export declare class TestRunsController {
    ...
    constructor(testDefinitionService: TestDefinitionService, testRunRepository: TestRunRepository, testCaseExecutionRepository: TestCaseExecutionRepository, testRunnerService: TestRunnerService, instanceSettings: InstanceSettings);
