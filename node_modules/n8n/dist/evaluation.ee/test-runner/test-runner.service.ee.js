...
let TestRunnerService = class TestRunnerService {
    ...
    async runTestCaseEvaluation(evaluationWorkflow, expectedData, actualData, abortSignal, metadata) {
        if (abortSignal.aborted) {
            return;
        }
        ...
        try {
            ...
            for (const pastExecutionId of pastExecutionIds) {
                ...
                try {
                    ...
                    const evalExecution = await this.runTestCaseEvaluation(evaluationWorkflow, originalRunData, testCaseRunData, abortSignal, testCaseMetadata);
