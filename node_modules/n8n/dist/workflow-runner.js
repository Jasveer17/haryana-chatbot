...
let WorkflowRunner = class WorkflowRunner {
    constructor(logger, errorReporter, activeExecutions, executionRepository, workflowStaticDataService, nodeTypes, permissionChecker, instanceSettings, manualExecutionService) {
        this.logger = logger;
