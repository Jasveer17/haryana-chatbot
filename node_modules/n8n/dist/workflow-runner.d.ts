...
export declare class WorkflowRunner {
    ...
    constructor(logger: Logger, errorReporter: ErrorReporter, activeExecutions: ActiveExecutions, executionRepository: ExecutionRepository, workflowStaticDataService: WorkflowStaticDataService, nodeTypes: NodeTypes, permissionChecker: PermissionChecker, instanceSettings: InstanceSettings, manualExecutionService: ManualExecutionService);
