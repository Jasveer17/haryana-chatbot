const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/NodeCreator-D9_PcE8r.js","assets/index-K8BpgYqJ.js","assets/index-xKO0gQfI.css","assets/useCanvasMapping-BxPYFPQz.js","assets/useRunWorkflow-l3u9xufx.js","assets/pushConnection.store-DzrhMqRY.js","assets/useCanvasMapping-DeC609A4.css","assets/NodeCreator-DDiuO5S0.css"])))=>i.map(i=>d[i]);
import { bo as useNodeTypesStore, dI as NODE_CREATOR_OPEN_SOURCES, q as computed, g as useI18n, bJ as MANUAL_TRIGGER_NODE_TYPE, iu as CHAIN_LLM_LANGCHAIN_NODE_TYPE, bh as NodeConnectionType, b7 as CHAT_TRIGGER_NODE_TYPE, iv as OPEN_AI_NODE_MESSAGE_ASSISTANT_TYPE, iw as OPEN_AI_NODE_TYPE, hg as SPLIT_IN_BATCHES_NODE_TYPE, dm as NO_OP_NODE_TYPE, T as useWorkflowsStore, aT as useExternalHooks, bK as WEBHOOK_NODE_TYPE, gX as SCHEDULE_TRIGGER_NODE_TYPE, aB as STICKY_NODE_TYPE, $ as useCanvasStore, gL as AI_CATEGORY_LANGUAGE_MODELS, dT as TRIGGER_NODE_CREATOR_VIEW, ix as QA_CHAIN_NODE_TYPE, iy as AGENT_NODE_TYPE, iz as BASIC_CHAIN_NODE_TYPE, iA as OPEN_AI_ASSISTANT_NODE_TYPE, d as defineComponent, K as useUIStore, r as ref, c9 as useThrottleFn, o as onMounted, x as onBeforeUnmount, m as resolveComponent, c as openBlock, h as createElementBlock, n as normalizeClass, j as createBaseVNode, i as createVNode, w as withCtx, l as unref, dH as KeyboardShortcutTooltip, f as createCommentVNode, e as createBlock, ct as Suspense, F as Fragment, cE as defineAsyncComponent, ar as __vitePreload, iB as getMidCanvasPosition, iC as DEFAULT_STICKY_WIDTH, iD as DEFAULT_STICKY_HEIGHT, _ as _export_sfc } from "./index-K8BpgYqJ.js";
import { a as useNodeCreatorStore, t as transformNodeType, s as sortNodeCreateElements } from "./useCanvasMapping-BxPYFPQz.js";
const useActions = () => {
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    const LazyNodeCreator = defineAsyncComponent(
      async () => await __vitePreload(() => import("./NodeCreator-D9_PcE8r.js"), true ? __vite__mapDeps([0,1,2,3,4,5,6,7]) : void 0)
    );
    const props = __props;
    const emit = __emit;
