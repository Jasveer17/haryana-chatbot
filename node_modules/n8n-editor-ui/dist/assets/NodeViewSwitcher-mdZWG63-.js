...
const _sfc_main$k = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    const LazyRunDataTable = defineAsyncComponent(
      async () => await __vitePreload(() => import("./RunDataTable-Di4ZRdsP.js"), true ? __vite__mapDeps([0,1,2,3,4]) : void 0)
    );
    const LazyRunDataJson = defineAsyncComponent(
      async () => await __vitePreload(() => import("./RunDataJson-BKSpe5ct.js"), true ? __vite__mapDeps([5,1,2,6,7,8,9,10,11,12,3,13,14,15,16,17,18,19]) : void 0)
    );
    const LazyRunDataSchema = defineAsyncComponent(
      async () => await __vitePreload(() => import("./index-DCrfHAqy.js").then((n) => n.iW), true ? __vite__mapDeps([1,2]) : void 0)
    );
    ...
    const LazyRunDataSearch = defineAsyncComponent(
      async () => await __vitePreload(() => import("./RunDataSearch-Cr7Vco2g.js"), true ? __vite__mapDeps([20,1,2,21]) : void 0)
    );
    const props = __props;
    const emit = __emit;
...
const LazyNodeCreation = defineAsyncComponent(
  async () => await __vitePreload(() => import("./NodeCreation-DY007rCJ.js").then((n) => n.N), true ? __vite__mapDeps([22,1,2,6,7,8,9,23]) : void 0)
);
const LazyCanvasControls = defineAsyncComponent(
  async () => await __vitePreload(() => import("./CanvasControls-BYFrPavs.js"), true ? __vite__mapDeps([24,1,2,25]) : void 0)
);
const LazySetupWorkflowCredentialsButton = defineAsyncComponent(
  async () => await __vitePreload(() => import("./SetupWorkflowCredentialsButton-D5_n7ODz.js"), true ? __vite__mapDeps([26,1,2]) : void 0)
);
