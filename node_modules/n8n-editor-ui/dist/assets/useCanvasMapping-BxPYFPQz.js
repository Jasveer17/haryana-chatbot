import { gt as createCompounder, gu as SetCache, gv as arrayIncludes, gw as cacheHas, gx as baseRest, gy as isArrayLikeObject, gz as baseFlatten, r as ref, K as useUIStore, bo as useNodeTypesStore, T as useWorkflowsStore, a0 as useSourceControlStore, q as computed, al as getResourcePermissions, cK as isPresent, H as watch, dD as getMousePosition$1, aB as STICKY_NODE_TYPE, g as useI18n, gA as NOT_DUPLICATABLE_NODE_TYPES, d as defineComponent, E as onClickOutside, l as unref, c as openBlock, e as createBlock, j as createBaseVNode, i as createVNode, w as withCtx, n as normalizeClass, gB as N8nActionDropdown, B as normalizeStyle, gC as Teleport, f as createCommentVNode, _ as _export_sfc$1, bk as v4, cI as CORE_NODES_CATEGORY, gD as DEFAULT_SUBCATEGORY, p as useSettingsStore, gE as AI_TRANSFORM_NODE_TYPE, gF as sublimeSearch, ba as AI_SUBCATEGORY, bb as AI_CATEGORY_AGENTS, gG as sortBy, fY as i18n, gH as AI_CATEGORY_OTHER_TOOLS, dx as SEND_AND_WAIT_OPERATION, gI as HUMAN_IN_THE_LOOP_CATEGORY, gJ as AI_OTHERS_NODE_CREATOR_VIEW, gK as AI_CATEGORY_DOCUMENT_LOADERS, bh as NodeConnectionType, gL as AI_CATEGORY_LANGUAGE_MODELS, gM as AI_CATEGORY_MEMORY, gN as AI_CATEGORY_OUTPUTPARSER, gO as AI_CATEGORY_RETRIEVERS, gP as AI_CATEGORY_TEXT_SPLITTERS, gQ as AI_CATEGORY_TOOLS, gR as AI_WORKFLOW_TOOL_LANGCHAIN_NODE_TYPE, gS as AI_CODE_TOOL_LANGCHAIN_NODE_TYPE, gT as AI_CATEGORY_EMBEDDING, gU as AI_CATEGORY_VECTOR_STORES, gV as AI_UNCATEGORIZED_CATEGORY, aM as useTemplatesStore, es as AI_NODE_CREATOR_VIEW, dT as TRIGGER_NODE_CREATOR_VIEW, bJ as MANUAL_TRIGGER_NODE_TYPE, bK as WEBHOOK_NODE_TYPE, gW as EMAIL_IMAP_NODE_TYPE, gX as SCHEDULE_TRIGGER_NODE_TYPE, bz as FORM_TRIGGER_NODE_TYPE, gd as EXECUTE_WORKFLOW_TRIGGER_NODE_TYPE, b7 as CHAT_TRIGGER_NODE_TYPE, gY as OTHER_TRIGGER_NODES_SUBCATEGORY, eL as REGULAR_NODE_CREATOR_VIEW, gZ as RSS_READ_NODE_TYPE, g_ as EMAIL_SEND_NODE_TYPE, g$ as TRANSFORM_DATA_SUBCATEGORY, h0 as FILTER_NODE_TYPE, h1 as REMOVE_DUPLICATES_NODE_TYPE, h2 as SPLIT_OUT_NODE_TYPE, h3 as LIMIT_NODE_TYPE, h4 as SUMMARIZE_NODE_TYPE, h5 as AGGREGATE_NODE_TYPE, h6 as MERGE_NODE_TYPE, cq as HTML_NODE_TYPE, h7 as MARKDOWN_NODE_TYPE, h8 as XML_NODE_TYPE, h9 as CRYPTO_NODE_TYPE, ha as EXTRACT_FROM_FILE_NODE_TYPE, hb as CONVERT_TO_FILE_NODE_TYPE, hc as COMPRESSION_NODE_TYPE, hd as EDIT_IMAGE_NODE_TYPE, he as FLOWS_CONTROL_SUBCATEGORY, hf as IF_NODE_TYPE, hg as SPLIT_IN_BATCHES_NODE_TYPE, hh as HELPERS_SUBCATEGORY, hi as HTTP_REQUEST_NODE_TYPE, hj as CODE_NODE_TYPE, hk as HITL_SUBCATEGORY, bc as AI_CATEGORY_CHAINS, hl as SET_NODE_TYPE, hm as DATETIME_NODE_TYPE, R as defineStore, $ as useCanvasStore, hn as AI_CATEGORY_ROOT_NODES, y as nextTick, bd as AI_CODE_NODE_TYPE, bL as AI_TRANSFORM_NODE_TYPE$1, eU as CanvasConnectionMode, ho as isValidCanvasConnectionMode, db as isValidNodeConnectionType, S as STORES, as as useNDVStore, dI as NODE_CREATOR_OPEN_SOURCES, hp as isVueFlowConnection, be as getNodeInputs, dt as CUSTOM_API_CALL_KEY, aT as useExternalHooks, aj as useTelemetry, hq as effectScope, ck as toRef, h as createElementBlock, s as renderSlot, ca as useSlots, bq as provide, b4 as onUnmounted, aw as onBeforeMount, o as onMounted, hr as useAttrs, a$ as mergeProps, F as Fragment, d9 as getCurrentInstance, dC as reactive, aW as inject, t as toDisplayString, A as renderList, x as onBeforeUnmount, hs as isMemoSame, ht as getCurrentScope, hu as onScopeDispose, aX as isRef, aY as toRefs$1, hv as customRef, hw as toValue$1, hx as createPropsRestProxy, b0 as resolveDynamicComponent, k as createTextVNode, m as resolveComponent, ap as h, hy as readonly, hz as markRaw, dH as KeyboardShortcutTooltip, hA as CanvasKey, aa as useCssModule, bn as watchEffect, aZ as normalizeProps, hB as CanvasNodeKey, eR as CanvasNodeRenderType, hC as refThrottled, hD as mergeModels, hE as useModel, bp as useNodeHelpers, bI as TitledList, av as useLocalStorage, hF as LOCAL_STORAGE_CANVAS_TRIGGER_BUTTON_VARIANT, du as FontAwesomeIcon, ac as nodeViewEventBus, hG as CanvasNodeHandleKey, ax as withDirectives, ay as vShow, d1 as Transition$2, Z as useRootStore, bS as useCredentialsStore, bV as useHistoryStore, D as useTagsStore, at as useExecutionsStore, a1 as useProjectsStore, a as useToast, a4 as useWorkflowHelpers, b6 as useClipboard, dW as MoveNodeCommand, c3 as RenameNodeCommand, ec as AddConnectionCommand, eP as RemoveNodeCommand, eN as useDataSchema, e1 as NODE_SIZE, dp as GRID_SIZE, hH as AddNodeCommand, b$ as getNodeParameters, dY as getNewNodePosition, hI as DEFAULT_NODE_SIZE, hJ as CONFIGURATION_NODE_SIZE, bf as getConnectionTypes, bg as getNodeOutputs, e2 as generateOffsets, hK as CONFIGURABLE_NODE_SIZE, e0 as PUSH_NODES_OFFSET, em as RemoveConnectionCommand, dX as UPDATE_WEBHOOK_ID_NODE_TYPES, dR as generateNodesGraph, a8 as EnterpriseEditionFeature, c0 as deepCopy, b as useRouter, I as withModifiers, bs as _sfc_main$y, C as createEventBus, bQ as isEqual, hL as useActiveElement, d4 as useDeviceSupport, hM as useEventListener$1, aS as createSlots, c9 as useThrottleFn, hN as onKeyDown, hO as onKeyUp, a_ as guardReactiveProps, ct as Suspense, d3 as getTriggerNodeServiceName, e_ as sanitizeHtml, bH as nodeIssuesToString, dw as WAIT_NODE_TYPE, dy as FORM_NODE_TYPE, dz as WAIT_INDEFINITELY } from "./index-K8BpgYqJ.js";
import { c as capitalize, u as usePinnedData, a as useRunWorkflow } from "./useRunWorkflow-l3u9xufx.js";
...
const __unplugin_components_2 = /* @__PURE__ */ _export_sfc$1(_sfc_main$p, [["__cssModules", cssModules$j]]);
...
const __unplugin_components_1 = /* @__PURE__ */ _export_sfc$1(_sfc_main$o, [["__cssModules", cssModules$i]]);
...
const __unplugin_components_0$4 = /* @__PURE__ */ _export_sfc$1(_sfc_main$n, [["__cssModules", cssModules$h]]);
...
const _sfc_main$m = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const triggerButtonVariant = useLocalStorage(LOCAL_STORAGE_CANVAS_TRIGGER_BUTTON_VARIANT, 2);
    watch(initialized, () => {
      ...
      return openBlock(), createElementBlock("div", {
        ...
        createBaseVNode("div", {
          ...
          unref(label2) ? (openBlock(), createElementBlock("div", {
            ...
            renderOptions.value.trigger && unref(triggerButtonVariant) === 1 ? (openBlock(), createElementBlock("div", {
              key: 0,
...
const node = "_node_srgxj_123";
const trigger$1 = "_trigger_srgxj_155";
const configuration = "_configuration_srgxj_158";
const statusIcons = "_statusIcons_srgxj_165";
const configurable = "_configurable_srgxj_168";
const description = "_description_srgxj_179";
const label$5 = "_label_srgxj_188";
const selected$1 = "_selected_srgxj_198";
const success$1 = "_success_srgxj_201";
const error = "_error_srgxj_204";
const pinned = "_pinned_srgxj_207";
const disabled = "_disabled_srgxj_210";
const running = "_running_srgxj_213";
const waiting = "_waiting_srgxj_217";
const disabledLabel = "_disabledLabel_srgxj_234";
const subtitle = "_subtitle_srgxj_247";
const triggerIcon = "_triggerIcon_srgxj_265";
const style0$g = {
  node,
  trigger: trigger$1,
  configuration,
...
const CanvasNodeDefault = /* @__PURE__ */ _export_sfc$1(_sfc_main$m, [["__cssModules", cssModules$g]]);
...
const CanvasNodeStickyNote = /* @__PURE__ */ _export_sfc$1(_sfc_main$k, [["__cssModules", cssModules$f]]);
...
const CanvasNodeAddNodes = /* @__PURE__ */ _export_sfc$1(_sfc_main$j, [["__cssModules", cssModules$e]]);
...
const __unplugin_components_0$3 = /* @__PURE__ */ _export_sfc$1(_sfc_main$h, [["__cssModules", cssModules$d]]);
...
const CanvasHandleMainInput = /* @__PURE__ */ _export_sfc$1(_sfc_main$g, [["__cssModules", cssModules$c]]);
...
const CanvasHandlePlus = /* @__PURE__ */ _export_sfc$1(_sfc_main$f, [["__cssModules", cssModules$b]]);
...
const __unplugin_components_0$2 = /* @__PURE__ */ _export_sfc$1(_sfc_main$e, [["__cssModules", cssModules$a]]);
...
const CanvasHandleMainOutput = /* @__PURE__ */ _export_sfc$1(_sfc_main$d, [["__cssModules", cssModules$9]]);
...
const __unplugin_components_0$1 = /* @__PURE__ */ _export_sfc$1(_sfc_main$c, [["__cssModules", cssModules$8]]);
...
const CanvasHandleNonMainInput = /* @__PURE__ */ _export_sfc$1(_sfc_main$b, [["__cssModules", cssModules$7]]);
...
const CanvasHandleNonMainOutput = /* @__PURE__ */ _export_sfc$1(_sfc_main$a, [["__cssModules", cssModules$6]]);
...
const CanvasHandleRenderer = /* @__PURE__ */ _export_sfc$1(_sfc_main$9, [["__cssModules", cssModules$5]]);
function useCanvasOperations({ router }) {
  ...
  async function importTemplate({
    ...
    workflowsStore.addToWorkflowMetadata({ templateId: `${id2}` });
  }
  return {
    lastClickPosition,
    editableWorkflow,
...
const _sfc_main$8 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const variant = useLocalStorage(LOCAL_STORAGE_CANVAS_TRIGGER_BUTTON_VARIANT, 2);
    const style = useCssModule();
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", {
        ...
        createBaseVNode("div", null, [
          unref(variant) === 2 ? (openBlock(), createElementBlock("div", {
            key: 0,
          ...
          !_ctx.readOnly ? (openBlock(), createElementBlock(Fragment, { key: 1 }, [
            unref(variant) === 1 && _ctx.type === unref(CHAT_TRIGGER_NODE_TYPE) ? (openBlock(), createBlock(_component_N8nButton, {
              key: 0,
              type: "secondary",
              size: "large",
              ...
              default: withCtx(() => [
                createTextVNode(toDisplayString(isChatOpen.value ? unref(i18n2).baseText("chat.hide") : unref(i18n2).baseText("chat.open")), 1)
              ]),
              _: 1
            }, 8, ["disabled", "data-test-id"])) : unref(variant) === 1 ? (openBlock(), createBlock(_component_N8nButton, {
              key: 1,
              type: "secondary",
              size: "large",
              disabled: isExecuting.value,
              ...
              default: withCtx(() => [
                createTextVNode(toDisplayString(unref(i18n2).baseText("nodeView.runButtonText.executeWorkflow")), 1)
              ]),
              _: 1
            }, 8, ["disabled", "data-test-id"])) : unref(variant) === 2 && _ctx.type === unref(CHAT_TRIGGER_NODE_TYPE) ? (openBlock(), createBlock(_component_N8nButton, {
              key: 2,
              type: isChatOpen.value ? "secondary" : "primary",
              size: "large",
              disabled: isExecuting.value,
              "data-test-id": testId.value,
              label: isChatOpen.value ? unref(i18n2).baseText("chat.hide") : unref(i18n2).baseText("chat.open"),
              onClickCapture: _cache[2] || (_cache[2] = ($event) => unref(toggleChatOpen)("node"))
              ...
              onClickCapture: _cache[3] || (_cache[3] = ($event) => unref(runEntireWorkflow)("node", _ctx.name))
...
const container = "_container_xb00u_123";
const interactive = "_interactive_xb00u_138";
const hovered = "_hovered_xb00u_138";
const variant1 = "_variant1_xb00u_142";
const variant2 = "_variant2_xb00u_150";
const bolt = "_bolt_xb00u_161";
const style0$4 = {
  container,
  interactive,
  hovered,
...
const CanvasNodeTrigger = /* @__PURE__ */ _export_sfc$1(_sfc_main$8, [["__cssModules", cssModules$4]]);
...
const __unplugin_components_0 = /* @__PURE__ */ _export_sfc$1(_sfc_main, [["__cssModules", cssModules], ["__scopeId", "data-v-f36970dd"]]);
