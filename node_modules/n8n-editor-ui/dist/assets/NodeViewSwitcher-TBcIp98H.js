const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/RunDataTable-DdJRWgLR.js","assets/index-K8BpgYqJ.js","assets/index-xKO0gQfI.css","assets/useExecutionHelpers-DenejMFG.js","assets/RunDataTable-CX7gToH4.css","assets/RunDataJson-CW7C2m_P.js","assets/useCanvasMapping-BxPYFPQz.js","assets/useRunWorkflow-l3u9xufx.js","assets/pushConnection.store-DzrhMqRY.js","assets/useCanvasMapping-DeC609A4.css","assets/import-curl-DOyAA20i.js","assets/FileSaver.min-B-pOQyH4.js","assets/RunDataAi-B7DCoEDw.js","assets/RunDataAi-DWoFsQdi.css","assets/useWorkflowActivate-CknxcljT.js","assets/global-link-actions-BF3LE-Rv.js","assets/useExecutionDebugging-DrCoOq-l.js","assets/useBeforeUnload-Bxdq5Kul.js","assets/easyAiWorkflowUtils-CUbLVYYu.js","assets/RunDataJson-Txw0lqay.css","assets/RunDataSearch-RRIQzayu.js","assets/RunDataSearch-R6qtl0Jf.css","assets/NodeCreation-BL9Tlay1.js","assets/NodeCreation-RKvezEeg.css","assets/CanvasControls-DXhne64d.js","assets/CanvasControls-DTjEPKS0.css","assets/SetupWorkflowCredentialsButton-XtLKAT7H.js"])))=>i.map(i=>d[i]);
import { br as hasKey, d as defineComponent, r as ref, q as computed, c as openBlock, h as createElementBlock, j as createBaseVNode, i as createVNode, bs as _sfc_main$z, n as normalizeClass, w as withCtx, k as createTextVNode, t as toDisplayString, e as createBlock, f as createCommentVNode, l as unref, G as withKeys, I as withModifiers, g as useI18n, y as nextTick, m as resolveComponent, _ as _export_sfc, as as useNDVStore, T as useWorkflowsStore, bt as isCommunityPackageName, bu as NPM_PACKAGE_DOCS_BASE_URL, bv as BUILTIN_NODES_DOCS_URL, bw as COMMUNITY_NODES_INSTALLATION_DOCS_URL, bh as NodeConnectionType, aT as useExternalHooks, aj as useTelemetry, b as useRouter, b6 as useClipboard, a4 as useWorkflowHelpers, a as useToast, bx as OPEN_URL_PANEL_TRIGGER_NODE_TYPES, H as watch, F as Fragment, A as renderList, by as PRODUCTION_ONLY_TRIGGER_NODE_TYPES, bz as FORM_TRIGGER_NODE_TYPE, b7 as CHAT_TRIGGER_NODE_TYPE, E as onClickOutside, ap as h, bA as toValue, bB as toRef, bC as tryOnScopeDispose, bD as isIOS, bE as noop, bF as isObject, bG as isClient, bo as useNodeTypesStore, bp as useNodeHelpers, J as useDebounce, B as normalizeStyle, bH as nodeIssuesToString, be as getNodeInputs, bI as TitledList, K as useUIStore, a$ as mergeProps, bJ as MANUAL_TRIGGER_NODE_TYPE, bK as WEBHOOK_NODE_TYPE, bL as AI_TRANSFORM_NODE_TYPE, bM as AI_TRANSFORM_CODE_GENERATED_FOR_PROMPT, bN as generateCodeForAiTransform, bO as AI_TRANSFORM_JS_CODE, ac as nodeViewEventBus, ak as useMessage, ae as MODAL_CONFIRM, bP as SWITCH_NODE_TYPE, bQ as isEqual, bR as captureException, p as useSettingsStore, au as usePostHog, bS as useCredentialsStore, u as useUsersStore, a1 as useProjectsStore, bT as OPEN_AI_API_CREDENTIAL_TYPE, bU as AI_CREDITS_EXPERIMENT, bV as useHistoryStore, o as onMounted, bW as ndvEventBus, x as onBeforeUnmount, bX as CUSTOM_NODES_DOCS_URL, ax as withDirectives, ay as vShow, bY as NodeCredentials, bZ as _sfc_main$A, b_ as ProjectTypes, bf as getConnectionTypes, bj as get, b$ as getNodeParameters, c0 as deepCopy, c1 as set, c2 as unset, c3 as RenameNodeCommand, c4 as isINodePropertyCollectionList, c5 as isINodePropertiesList, c6 as isINodePropertyOptionsList, c7 as displayParameter, c8 as Draggable, c9 as useThrottleFn, ca as useSlots, aI as useStorage, cb as LOCAL_STORAGE_MAIN_PANEL_RELATIVE_WIDTH, s as renderSlot, cc as MAIN_NODE_PANEL_WIDTH, cd as requireVue, ce as getDefaultExportFromCjs, cf as sanitizeHtmlExports, cg as sanitizeHtml, ch as jsonParse, aO as N8nLink, ci as N8nText, aQ as _sfc_main$B, aP as N8nTooltip, a0 as useSourceControlStore, Z as useRootStore, cj as useSchemaPreviewStore, U as useRoute, ck as toRef$1, cl as storeToRefs, cm as computedAsync, cn as dataPinningEventBus, co as MAX_DISPLAY_DATA_SIZE_SCHEMA_VIEW, cp as MAX_DISPLAY_DATA_SIZE, cq as HTML_NODE_TYPE, cr as DATA_PINNING_DOCS_URL, cs as N8nCallout, ct as Suspense, cu as N8nRadioButtons, cv as N8nButton, cw as N8nSelect, cx as N8nTabs, cy as _sfc_main$C, cz as JsonEditor, cA as DATA_EDITING_DOCS_URL, cB as InfoTip, cC as _sfc_main$E, cD as N8nBlockUi, cE as defineAsyncComponent, cF as TRIMMED_TASK_DATA_CONNECTIONS_KEY, cG as executionDataToJson, cH as NODE_TYPES_EXCLUDED_FROM_OUTPUT_NAME_APPEND, cI as CORE_NODES_CATEGORY, cJ as SCHEMA_PREVIEW_EXPERIMENT, cK as isPresent, cL as isEmpty, bg as getNodeOutputs, cM as getNodeHints, cN as getGenericHints, cO as LOCAL_STORAGE_PIN_DATA_DISCOVERY_NDV_FLAG, cP as LOCAL_STORAGE_PIN_DATA_DISCOVERY_CANVAS_FLAG, cQ as clearJsonKey, cR as searchInObject, cS as isObject$1, cT as resolveDirective, cU as TEST_PIN_DATA, ar as __vitePreload, aS as createSlots, cV as waitingNodeTooltip, cW as truncate, cX as createStaticVNode, b0 as resolveDynamicComponent, cY as uniqBy, cZ as START_NODE_TYPE, c_ as CRON_NODE_TYPE, c$ as INTERVAL_NODE_TYPE, d0 as CopyInput, d1 as Transition, C as createEventBus, d2 as isTriggerPanelObject, d3 as getTriggerNodeServiceName, V as VIEWS, af as WORKFLOW_SETTINGS_MODAL_KEY, d4 as useDeviceSupport, d5 as APP_MODALS_ELEMENT_ID, d6 as useStyles, d7 as EXECUTABLE_TRIGGER_NODE_TYPES, aB as STICKY_NODE_TYPE, d8 as BASE_NODE_SURVEY_URL, a8 as EnterpriseEditionFeature, d9 as getCurrentInstance, da as getAnchorPosition, db as isValidNodeConnectionType, dc as getEndpointScope, dd as getInputEndpointUUID, de as getInputEndpointStyle, df as getScope, dg as getInputNameOverlay, dh as NODE_INSERT_SPACER_BETWEEN_INPUT_GROUPS, di as NODE_MIN_INPUT_ITEMS_COUNT, dj as getOutputEndpointUUID, dk as getOutputEndpointStyle, dl as getOutputNameOverlay, dm as NO_OP_NODE_TYPE, dn as NODE_CONNECTION_TYPE_ALLOW_MULTIPLE, dp as GRID_SIZE, dq as isString, dr as isNumber, ds as assert, dt as CUSTOM_API_CALL_KEY, du as FontAwesomeIcon, dv as xss, dw as WAIT_NODE_TYPE, dx as SEND_AND_WAIT_OPERATION, dy as FORM_NODE_TYPE, dz as WAIT_INDEFINITELY, dA as SIMULATE_NODE_TYPE, dB as SIMULATE_TRIGGER_NODE_TYPE, dC as reactive, b4 as onUnmounted, $ as useCanvasStore, dD as getMousePosition, dE as getRelativePosition, dF as MOUSE_EVENT_BUTTON, dG as MOUSE_EVENT_BUTTONS, dH as KeyboardShortcutTooltip, a3 as useDocumentTitle, dI as NODE_CREATOR_OPEN_SOURCES, dJ as mapStores, a2 as useNpsSurveyStore, at as useExecutionsStore, dK as useExternalSecretsStore, dL as useWorkflowsEEStore, dM as useEnvironmentsStore, aM as useTemplatesStore, D as useTagsStore, dN as getBackgroundStyles, b8 as MANUAL_CHAT_TRIGGER_NODE_TYPE, al as getResourcePermissions, dO as getNodeViewTab, X as PLACEHOLDER_EMPTY_WORKFLOW_ID, an as MAIN_HEADER_TABS, dP as ready, aE as sourceControlEventBus, dQ as historyBus, dR as generateNodesGraph, dS as N8nAddInputEndpointType, dT as TRIGGER_NODE_CREATOR_VIEW, dU as getFixedNodesList, dV as tryToParseNumber, dW as MoveNodeCommand, ah as VALID_WORKFLOW_IMPORT_URL_REGEX, dX as UPDATE_WEBHOOK_ID_NODE_TYPES, bk as v4, dY as getNewNodePosition, dZ as DRAG_EVENT_DATA_KEY, d_ as getConnectorLengths, d$ as MAX_X_TO_PUSH_DOWNSTREAM_NODES, e0 as PUSH_NODES_OFFSET, e1 as NODE_SIZE, e2 as generateOffsets, e3 as nodeConnectionTypes, e4 as resetConnectionAfterPull, e5 as resetConnection, e6 as moveBackInputLabelPosition, e7 as hideOutputNameLabel, e8 as addConnectionActionsOverlay, e9 as getOverlay, ea as OVERLAY_ENDPOINT_ARROW_ID, eb as getConnectorPaintStyleData, ec as AddConnectionCommand, ed as addConnectionTestData, ee as showOrHideItemsLabel, ef as showOrHideMidpointArrow, eg as isJSPlumbConnection, eh as hideConnectionActions, ei as showConnectionActions, ej as resetInputLabelPosition, ek as getConnectionInfo, el as showOutputNameLabel, em as RemoveConnectionCommand, en as isJSPlumbEndpointElement, eo as isElementIntersection, ep as calculateElementIntersection, eq as showDropConnectionState, er as showPullConnectionState, es as AI_NODE_CREATOR_VIEW, et as EVENT_CONNECTION_ABORT, eu as INTERCEPT_BEFORE_DROP, ev as EVENT_CONNECTION, ew as EVENT_DRAG_MOVE, ex as EVENT_CONNECTION_MOUSEOVER, ey as EVENT_CONNECTION_MOUSEOUT, ez as EVENT_CONNECTION_MOVED, eA as EVENT_ENDPOINT_MOUSEOVER, eB as EVENT_ENDPOINT_MOUSEOUT, eC as EVENT_CONNECTION_DETACHED, eD as EVENT_CONNECTION_DRAG, eE as EVENT_PLUS_ENDPOINT_CLICK, eF as EVENT_ADD_INPUT_ENDPOINT_CLICK, eG as N8nPlusEndpointType, eH as CANVAS_AUTO_ADD_MANUAL_TRIGGER_EXPERIMENT, eI as MODAL_CANCEL, eJ as addClassesToOverlays, eK as getJSPlumbEndpoints, eL as REGULAR_NODE_CREATOR_VIEW, eM as isSubNodeType, eN as useDataSchema, eO as OVERLAY_RUN_ITEMS_ID, eP as RemoveNodeCommand, aa as useCssModule, eQ as NEW_WORKFLOW_ID, eR as CanvasNodeRenderType, aw as onBeforeMount, eS as onActivated, eT as onDeactivated, eU as CanvasConnectionMode, av as useLocalStorage, eV as onBeforeRouteLeave } from "./index-K8BpgYqJ.js";
import { u as useContextMenu, a as useNodeCreatorStore, C as ContextMenu, b as useUniqueNodeName, c as useViewStacks, d as useVueFlow, e as useCanvasMapping, _ as __unplugin_components_0$1, f as useCanvasOperations, g as createCanvasConnectionHandleString } from "./useCanvasMapping-BxPYFPQz.js";
import { a as useRunWorkflow, u as usePinnedData, b as useNodeType } from "./useRunWorkflow-l3u9xufx.js";
import { i as importCurlEventBus } from "./import-curl-DOyAA20i.js";
import { F as FileSaver_minExports } from "./FileSaver.min-B-pOQyH4.js";
import { _ as _sfc_main$D, R as RunDataAi } from "./RunDataAi-B7DCoEDw.js";
import { u as useExecutionHelpers, c as convertToDisplayDateComponents } from "./useExecutionHelpers-DenejMFG.js";
import { u as useWorkflowActivate } from "./useWorkflowActivate-CknxcljT.js";
import { g as globalLinkActionsEventBus } from "./global-link-actions-BF3LE-Rv.js";
import { u as useExecutionDebugging } from "./useExecutionDebugging-DrCoOq-l.js";
import { u as usePushConnectionStore } from "./pushConnection.store-DzrhMqRY.js";
import { u as useBeforeUnload } from "./useBeforeUnload-Bxdq5Kul.js";
...
const _sfc_main$k = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    const LazyRunDataTable = defineAsyncComponent(
      async () => await __vitePreload(() => import("./RunDataTable-DdJRWgLR.js"), true ? __vite__mapDeps([0,1,2,3,4]) : void 0)
    );
    const LazyRunDataJson = defineAsyncComponent(
      async () => await __vitePreload(() => import("./RunDataJson-CW7C2m_P.js"), true ? __vite__mapDeps([5,1,2,6,7,8,9,10,11,12,3,13,14,15,16,17,18,19]) : void 0)
    );
    const LazyRunDataSchema = defineAsyncComponent(
      async () => await __vitePreload(() => import("./index-K8BpgYqJ.js").then((n) => n.iX), true ? __vite__mapDeps([1,2]) : void 0)
    );
    ...
    const LazyRunDataSearch = defineAsyncComponent(
      async () => await __vitePreload(() => import("./RunDataSearch-RRIQzayu.js"), true ? __vite__mapDeps([20,1,2,21]) : void 0)
    );
    const props = __props;
    const emit = __emit;
...
const RunData = /* @__PURE__ */ _export_sfc(_sfc_main$k, [["__cssModules", cssModules$a], ["__scopeId", "data-v-cb603342"]]);
...
const __unplugin_components_1 = /* @__PURE__ */ _export_sfc(_sfc_main$c, [["__scopeId", "data-v-a00e30ef"]]);
...
const __unplugin_components_0 = /* @__PURE__ */ _export_sfc(_sfc_main$b, [["__scopeId", "data-v-8112a6bc"]]);
...
const LazyNodeCreation = defineAsyncComponent(
  async () => await __vitePreload(() => import("./NodeCreation-BL9Tlay1.js").then((n) => n.N), true ? __vite__mapDeps([22,1,2,6,7,8,9,23]) : void 0)
);
const LazyCanvasControls = defineAsyncComponent(
  async () => await __vitePreload(() => import("./CanvasControls-DXhne64d.js"), true ? __vite__mapDeps([24,1,2,25]) : void 0)
);
const LazySetupWorkflowCredentialsButton = defineAsyncComponent(
  async () => await __vitePreload(() => import("./SetupWorkflowCredentialsButton-XtLKAT7H.js"), true ? __vite__mapDeps([26,1,2]) : void 0)
);
    ...
    createBaseVNode("div", {
      ...
      !_ctx.isReadOnlyRoute && !_ctx.readOnlyEnv && (_ctx.workflowPermissions.update ?? _ctx.projectPermissions.workflow.update) ? (openBlock(), createElementBlock("div", _hoisted_2, [
        ...
        _ctx.containsChatNodes ? (openBlock(), createBlock(_component_n8n_button, {
          key: 1,
          label: _ctx.isChatOpen ? _ctx.i18n.baseText("chat.hide") : _ctx.i18n.baseText("chat.open"),
          size: "large",
          icon: "comment",
...
const NodeViewV1 = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["render", _sfc_render], ["__cssModules", cssModules$2], ["__scopeId", "data-v-403d1b31"]]);
