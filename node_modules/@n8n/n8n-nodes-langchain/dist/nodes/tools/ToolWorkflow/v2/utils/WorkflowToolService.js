...
class WorkflowToolService {
    ...
    async createTool({ name, description, itemIndex, }) {
        const toolHandler = async (query, runManager) => {
            ...
            try {
                ...
                void this.context.addOutputData("ai_tool", index, executionError, metadata);
    ...
    async extractFromAIParameters() {
        ...
        (0, n8n_workflow_1.traverseNodeParameters)(this.context.getNode().parameters, collectedArguments);
